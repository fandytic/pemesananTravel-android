...
public class TabPadang1 extends AppCompatActivity {
    TextView nohp;
    String txtnohp,id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_padang1);
    ...
    public void pesanasa(View view) {
        Intent i = new Intent(getApplicationContext(), Pesan.class);
        i.putExtra(TAG_ID, id);
        i.putExtra(TAG_NOHP, txtnohp);
        startActivity(i);
    ...
    public void petanusa(View view) {
        Intent i = new Intent(getApplicationContext(), MapsNusaMulya.class);
        startActivity(i);
    }
    ...
    public class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new TabFragmentPdgNusa1();
                case 1:
                    return new TabFragmentPdgNusa2();
                case 2:
                    return new TabFragmentPdgNusa3();
                default:
                    return null;
            }
        }
