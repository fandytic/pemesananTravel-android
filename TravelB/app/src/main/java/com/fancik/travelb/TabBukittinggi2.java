...
public class TabBukittinggi2 extends AppCompatActivity {
    TextView nohp;
    String txtnohp,id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_bukittinggi2);
    ...
    public void petatri(View view) {
        Intent i = new Intent(getApplicationContext(), MapsTriArga.class);
        startActivity(i);
    }

    public void pesaninova(View view) {
    ...
    public void pesanpesan(View view) {
        Intent i = new Intent(getApplicationContext(), Pesan.class);
        i.putExtra(TAG_ID, id);
        i.putExtra(TAG_NOHP, txtnohp);
        startActivity(i);
    ...
    public class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new TabFragmentBktTri1();
                case 1:
                    return new TabFragmentBktTri2();
                case 2:
                    return new TabFragmentBktTri3();
                default:
                    return null;
            }
        }
