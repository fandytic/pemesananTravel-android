...
public class PilihanTravelD extends AppCompatActivity {
    TextView txt_nohp;
    String nohp,id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pilihan_traveld);
    ...
    public void pilihbintang(View view) {
        Intent i = new Intent(getApplicationContext(), TabPayakumbuh1.class);
    ...
    public void pilihpermata(View view) {
        Intent i = new Intent(getApplicationContext(), TabPayakumbuh2.class);
        i.putExtra(TAG_ID, id);
        i.putExtra(TAG_NOHP, nohp);
        startActivity(i);
    }
