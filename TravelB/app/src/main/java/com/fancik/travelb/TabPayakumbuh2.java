...
public class TabPayakumbuh2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tab_payakumbuh2);
    ...
    public class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new TabFragmentPykPermata1();
                case 1:
                    return new TabFragmentPykPermata2();
                case 2:
                    return new TabFragmentPykPermata3();
                default:
                    return null;
            }
        }
